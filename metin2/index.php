  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="index.php?p=registro">REGISTRO <span class="sr-only">(current)</span></a></li>
    ...
    <form  class="navbar-form navbar-right" style="margin-top:7px;" name="iniciar_sesion" action="/entrar/" method="post">
                    <div class="form-group">
                        <input name="usuario" id="blanco" placeholder="Usuario" class="form-control input-sm" type="text">
                    </div>
                    <div class="form-group">
                        <input name="password" id="blanco" placeholder="Contraseña" class="form-control input-sm" type="password">
                    </div>
                    <a  type="submit" class="btn btn-success btn-sm"><em class="icon-ok"></em> Entrar</a>
                <a class="btn btn-warning btn-sm" href="#"><em class="icon-user"></em> Registrarse</a>
       </form> 
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
...
<div class="col-md-4" style="margin-top:-3%;"> 
  ...
  <div class="panel-body"> 
    <table class="table table-hover">
      <button class="btn btn-success" style="width:225px">Jugadores</button><button class="btn btn-warning" style="width:225px">Gremios</button>
      <table class="table">
        <tr>
          <th>#</th>
          <th>Personaje</th>
        ...
        <tr>
          <td>1</td>
          <th><img src="img/raza/0.png" alt="" class="img-circle"> <span style="color:#3FB618;">Lv</span> 99</th>
          <td><a href="">MaximoDecimo</a></td>
  ...
  <footer class="footer-distributed" style="margin-top:-10px;">
      ...
      <div class="footer-center">
        ...
        <div>
          ...
          <p><a href="mailto:support@company.com">support@animephones.net</a></p>
        </div>
      </div>
